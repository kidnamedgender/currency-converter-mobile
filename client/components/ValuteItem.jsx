        ...
        <View style={styles.container}>
            ...
            <View style={styles.values}>
                ...
                <Text
                    ...
                    {Value - Previous < 0 ? `${(Value - Previous).toFixed(2)}` : `+${(Value - Previous).toFixed(2)}`}
                </Text>
                <Text style={styles.percents}>
                    {Value - Previous < 0 ? `${(((Value - Previous) / Value) * 100).toFixed(2)}%` : `+${(((Value - Previous) / Value) * 100).toFixed(2)}%`}
                </Text>
            </View>
        </View>
    );
